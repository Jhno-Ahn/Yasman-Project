				...
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						<div class="login-wrap p-4 p-md-5 ">
							<div class="d-flex">
								<div class="w-100">
									<h3 class="mb-4" id = "input" style="font-family: inherit; color: grey ; font-weight: bold;">내 정보 변경</h3>
								</div>
							</div>
							<br><br>
							<form name = "modifyform" action="memberModifyPro.do?id=${id}" method = "post" class="signin-form" onsubmit = "return inputcheck()">
								<div class="form-group">
									<input id="password-field1" type="password" name="passwd" required name="pw1" value = "${dto.passwd}"
										pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
								...
								<div class="form-group">
									<input id="password-field2" type="password"  name="repasswd" class="form-control" name="pw2" value = "${dto.passwd}"
								...
								<div class="form-group">
									<input class="form-control" type="text" name="member_tel" value = "${dto.member_tel}" required >
									<label class="form-control-placeholder"style="color: gray;">연락처</label>
								</div>
								<div class="form-group">
									<input class="form-control btn btn-primary rounded submit px-3" type="submit" value="정보 변경">
								</div>
								<div class="text-center">
									<a href="myPage.do?id=${id}" style="color: var(--blue);">뒤로가기</a>
								</div>
							</form>
						</div>
					</div>
