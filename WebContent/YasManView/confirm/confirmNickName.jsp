										...
										<h5>${page_confirm}</h5>
											...
											<table border="1">
												...
												<tr>
													...
													onclick= "setnickname('${nick_name}')"></th>
												</tr>
											</table>
									</c:if>
									<c:if test = "${result ne 0}">
										<form method="post" name="confirmform" action="confirmNickName.do" onsubmit="return confirmnicknamecheck()">
											<table border = "1">
												<tr>
												...
												<tr>
													<th>${str_id}
													<td> <input class="input" type="text" name="nick_name" autofocus></td>
												</tr>
												<tr>
													<th colspan="2">
